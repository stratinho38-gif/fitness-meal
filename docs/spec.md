...
Έκδοση: **v8.2 (Υλικά γεύματος → λίστα ψώνων)** · Αρχείο εφαρμογής: `index.html` · Deployed: Netlify `lista-supemarket` + Cowork artifact `lista-psonon-stratos`
...
### Υλικά γεύματος → λίστα ψώνων (v8.2)

- Στο modal συνταγής, κάτω από τα «Υλικά»: επιλογέας λίστας (default η ενεργή) + κουμπί **«Όλα στη λίστα»** που προσθέτει **όλα τα υλικά** της συνταγής στην επιλεγμένη λίστα με μία κίνηση.
...
- Αν δεν υπάρχει καμία λίστα, δημιουργείται νέα λίστα **«Ψώνια»** με τα υλικά και γίνεται ενεργή.
